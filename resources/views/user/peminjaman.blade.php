                        ...
                        <table class="min-w-full table-auto text-left">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ...
                                <tr class="group hover:bg-gray-50/50 transition duration-150">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10 bg-gray-100 rounded-md flex items-center justify-center text-gray-400 mr-4 group-hover:bg-gray-200 transition">
                                                <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                                            </div>
                                            <div>
                                                <div class="text-sm font-bold text-gray-900">{{ $item->buku->judul }}</div>
                                                <div class="text-xs text-gray-500 font-medium">{{ $item->buku->penulis }}</div>
                                            </div>
                                        </div>
                                    </td>
